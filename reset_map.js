function reset(lat, lon) {
clearMap();
markerGroup = L.layerGroup().addTo(map);
current_location = L.layerGroup().addTo(map);
L.marker([lat, lon], {icon: redIcon}).addTo(current_location);
...
var request = new XMLHttpRequest();
var googleLatlong = new String();
googleLatlong = "https://maps.googleapis.com/maps/api/geocode/json?address=" + address;

console.log(googleLatlong);
request.open('GET', googleLatlong, true);
request.onload = function () {
